...
var helper = require('./ApplicationModule/helper.js');
var createChannel = require('./ApplicationModule/create-channel.js');
var join = require('./ApplicationModule/join-channel.js');
var updateAnchorPeers = require('./ApplicationModule/update-anchor-peers.js');
var install = require('./ApplicationModule/install-chaincode.js');
var instantiate = require('./ApplicationModule/instantiate-chaincode.js');
var invoke = require('./ApplicationModule/invoke-transaction.js');
var query = require('./ApplicationModule/query.js');
...
app.post('/users', async function(req, res) {
	...
	var token = jwt.sign({
		username: username,
		orgName: orgName
	}, app.get('secret'),{ expiresIn:hfc.getConfigSetting('jwt_expiretime'),});
...
app.post('/channels/:channelName/chaincodes/:chaincodeName', async function(req, res) {
	...
	console.log("Args after stringify : ",args)
...
app.get("/channels/blockHeight/:channelName",async (req,res)=>{
	...
	let message = await query.getBlockHeight(peer,req.params.channelName,req.username, req.orgname);
	res.send(message)
